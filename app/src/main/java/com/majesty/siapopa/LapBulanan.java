...
public class LapBulanan extends AppCompatActivity {
    EditText awal, akhir;
    Calendar myCalendar;
    ...
    String userAlamat, tambah_ringan, tambah_sedang, tambah_berat, tambah_puso, tanggal_intensitas, dateNow;
    Button btn_cetak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lap_bulanan);
        ...
        if (Common.currentUser.getId_usergroup().equals("2")){
            ...
            awal.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // TODO Auto-generated method stub
                    new DatePickerDialog(LapBulanan.this, date, myCalendar
            ...
            akhir.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // TODO Auto-generated method stub
                    new DatePickerDialog(LapBulanan.this, dateAkhir, myCalendar
                            .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                            myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                }
            });
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            jenis_opt.add(opt);
                            optAdapter = new ArrayAdapter<>(LapBulanan.this, R.layout.my_spinner, jenis_opt);
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            jenis_desa.add(desa);
                            desaAdapter = new ArrayAdapter<>(LapBulanan.this, R.layout.my_spinner, jenis_desa);
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if (object.getString("provinsi").equals("null")){
                                    ...
                                    Toast.makeText(LapBulanan.this, "No Data Found", Toast.LENGTH_LONG).show();
                                }else {
...
//                                    String intensitas_tambah = object.getString("intensitas_tambah");
                                    ...
                                    String pdfname = "Laporan Bulanan "+dateNow+".pdf";
                                    ...
                                    Paragraph title = new Paragraph("Laporan Bulanan", b);
...
//                                                document.add(image);
        ...
        Volley.newRequestQueue(LapBulanan.this).add(stringRequest);
    }
    ...
    private void previewPdf() {
        progressDialog.dismiss();
        Intent intent = new Intent(LapBulanan.this, PdfView.class);
        intent.putExtra("bulanan", "Laporan Bulanan "+dateNow+".pdf");
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == REQUEST_EXTERNAL_STORAGE) {// If request is cancelled, the result arrays are empty.
            if (grantResults.length <= 0
                ...
                Toast.makeText(LapBulanan.this, "Cannot write images to external storage", Toast.LENGTH_SHORT).show();
            }
        }
    }
