...
import com.majesty.siapopa.adapter.ApprPermohonanAdapter;
...
public class ApprovalPermohonan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approval_permohonan);

        toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Approval Permohonan");
        ...
        layoutManager = new LinearLayoutManager(ApprovalPermohonan.this);
...
//
    ...
    private void getLaporan(){
        ...
        String urlLaporan = Constants.ROOT_URL+"Approval_Permohonan?status=Belum";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlLaporan,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        mAdapter = new ApprPermohonanAdapter(ApprovalPermohonan.this, listHasil);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(ApprovalPermohonan.this, "No Data Found", Toast.LENGTH_LONG).show();
            }
        });
        Volley.newRequestQueue(ApprovalPermohonan.this).add(stringRequest);
    }
}