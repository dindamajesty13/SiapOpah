...
public class AdapterDesa extends RecyclerView.Adapter<AdapterDesa.MyViewHolder>{
    private Context mContext;
    private List<HasilModel> hasilModels = new ArrayList<>();


    public AdapterDesa (Context context,List<HasilModel> hasilModels){
