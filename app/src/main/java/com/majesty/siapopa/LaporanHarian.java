...
import com.majesty.siapopa.adapter.AdapterDesaHarian;
...
public class LaporanHarian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(LaporanHarian.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlLaporan,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        mAdapter = new AdapterDesaHarian(LaporanHarian.this, listHasil);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(LaporanHarian.this, "No Data Found", Toast.LENGTH_LONG).show();
            }
        });
        Volley.newRequestQueue(LaporanHarian.this).add(stringRequest);
    }
}