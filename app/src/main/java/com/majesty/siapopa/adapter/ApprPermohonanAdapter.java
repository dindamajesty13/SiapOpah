...
import com.majesty.siapopa.DetailApprovalPermohonan;
...
public class ApprPermohonanAdapter extends RecyclerView.Adapter<ApprPermohonanAdapter.MyViewHolder> {

    private Context mContext;
    private List<ModelPermohonan> laporan = new ArrayList<>();


    public ApprPermohonanAdapter(Context context, List<ModelPermohonan> laporan){
...
//    }
    ...
    @NonNull
    @Override
    public ApprPermohonanAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.approval_item,parent,false);
        return new ApprPermohonanAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ApprPermohonanAdapter.MyViewHolder holder, int position) {
...
//                onItemClickCallback.onItemClicked(laporan.get(holder.getAdapterPosition()));
                ...
                Intent intent = new Intent(mContext, DetailApprovalPermohonan.class);
