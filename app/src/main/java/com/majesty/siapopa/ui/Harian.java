...
import com.majesty.siapopa.adapter.AdapterPemberitahuan;
 ...
 * Use the {@link Harian#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Harian extends Fragment {
     ...
     * @return A new instance of fragment Harian.
     */
    // TODO: Rename and change types and number of parameters
    public static Harian newInstance(String param1, String param2) {
        Harian fragment = new Harian();
    ...
    private void getPemberitahuanProvinsi() {
        ...
        String urlLaporan = Constants.ROOT_URL+"Pemberitahuan?status=Belum&username="+username+"&tipe=harian&to=Provinsi";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i<array.length(); i++){
                                ...
                                String tanggal = object.getString("tanggal_intensitas");
                                ...
                                pemberitahuan.setId_hasil(id_hasil);
                        ...
                        mAdapter = new AdapterPemberitahuan(getActivity(), listPemberitahuan);
    ...
    private void getPemberitahuanSatPel() {
        ...
        String urlLaporan = Constants.ROOT_URL+"Pemberitahuan?status=Belum&username="+username+"&tipe=harian&to=SatPel";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlLaporan,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    private void getPemberitahuanKortikab() {
        ...
        progressDialog.show();
        String username = Common.currentUser.getKabupaten();
        String urlLaporan = Constants.ROOT_URL+"Pemberitahuan?status=Belum&username="+username+"&tipe=harian&to=Kortikab";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlLaporan,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    private void getPemberitahuan() {
        ...
        String urlLaporan = Constants.ROOT_URL+"Pemberitahuan?status=Belum&username="+username+"&tipe=harian";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlLaporan,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
