...
public class AdapterBulanan extends RecyclerView.Adapter<AdapterBulanan.MyViewHolder>{
    private Context mContext;
    private List<HasilModel> hasilModels = new ArrayList<>();


    public AdapterBulanan (Context context,List<HasilModel> hasilModels){
...
//        holder.txtDate.setText(Html.fromHtml("<font color='#6200EE'><b>Tanggal: </b><br></font>" +hasilModel.getTanggal_pengamatan()));
        holder.txtDesa.setText(Html.fromHtml("<font color='#6200EE'><b>Desa: </b><br></font>"+hasilModel.getDesa()));
